...
Citizen.CreateThread(function()
    BurgerShot = AddBlipForCoord(-1195.63, -893.05, 13.98)
    ...
    AddTextComponentSubstringPlayerName("Burger Shop")
...
AddEventHandler("qb-burgershot:MurderMeal", function()
		...
		elseif randomToy == 4 then
			TriggerServerEvent('QBCore:Server:AddItem', "cocaine_device", 1)
        	TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["cocaine_device"], "add")
		elseif randomToy < 10 and randomToy > 4 then
			QBCore.Functions.Notify("No Item in Box Looool", "error")
		elseif randomToy == 10 then
			TriggerServerEvent('QBCore:Server:AddItem', "actionfigure", 1)
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["actionfigure"], "add")
		else
            QBCore.Functions.Notify("No Item in Box Looool", "error")
        end
end)
    	...
    	QBCore.Functions.TriggerCallback('qb-burgershot:server:get:ingredientMurderMeal', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Making A Murder Meal..", 4000, false, true, {
                    ...
                    QBCore.Functions.Notify("You made a Burger Package", "success")
				end, function()
...
AddEventHandler("qb-burgershot:BleederBurger", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-burgershot:server:get:ingredientBurgerBleeder', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Making Burgers..", 4000, false, true, {
					...
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-meat", 2)
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-lettuce", 2)
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-bun", 1)
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-tomato", 3)
                    ...
                    QBCore.Functions.Notify("You made a Double Sheek Burger", "success")
				end, function()
					QBCore.Functions.Notify("Cancelled..", "error")
				end)
			else
...
AddEventHandler("qb-burgershot:MoneyShot", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-burgershot:server:get:ingredientBurgerMoneyShot', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Making Burgers..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					...
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-lettuce", 2)
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-bun", 1)
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-tomato", 2)
                    ...
                    QBCore.Functions.Notify("You made a Single Sheek Burger", "success")
				end, function()
					QBCore.Functions.Notify("Cancelled..", "error")
				end)
			else
...
AddEventHandler("qb-burgershot:HeartStopper", function()
    if onDuty then
    	QBCore.Functions.TriggerCallback('qb-burgershot:server:get:ingredientBurgerHeartStopper', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Making Burgers..", 4000, false, true, {
					disableMovement = true,
					disableCarMovement = true,
					...
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-meat", 3)
                    ...
                    QBCore.Functions.Notify("You made a Triple Sheek Burger", "success")
				end, function()
					QBCore.Functions.Notify("Cancelled..", "error")
				end)
			else
    	...
    	QBCore.Functions.TriggerCallback('qb-burgershot:server:get:ingredientTorpedo', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Making A Torpedo..", 4000, false, true, {
                    ...
                    QBCore.Functions.Notify("You made a Chicken Roll", "success")
				end, function()
					QBCore.Functions.Notify("Cancelled..", "error")
				end)
			else
    	...
    	QBCore.Functions.TriggerCallback('qb-burgershot:server:get:ingredientMeatfree', function(HasItems)  
    		if HasItems then
				QBCore.Functions.Progressbar("pickup_sla", "Making A Meat Free Burger..", 4000, false, true, {
					...
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-tomato", 2)
                    TriggerServerEvent('QBCore:Server:RemoveItem', "burger-lettuce", 2)
					TriggerServerEvent('QBCore:Server:RemoveItem', "burger-bun", 2)
